...
using Enums_AiringStatus = Aosta.Data.Database.Enums.AiringStatus;
using Enums_Season = Aosta.Data.Database.Enums.Season;
...
public partial class JikanAnime : IEmbeddedObject
{
	...
	/// </summary>
	[Ignored]
	public Enums_AiringStatus Status
	{
		get => (Enums_AiringStatus)status;
	...
	/// </summary>
	[Ignored]
	public Enums_Season Season
	{
		get => (Enums_Season)season;
