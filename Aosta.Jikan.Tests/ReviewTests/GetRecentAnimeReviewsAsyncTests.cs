...
public class GetRecentAnimeReviewsAsyncTests
{
    ...
    {
        // When
        var func = JikanTests.Instance.Awaiting(x => x.GetRecentAnimeReviewsAsync(page));
    ...
    {
        // When
        var reviews = await JikanTests.Instance.GetRecentAnimeReviewsAsync();
    ...
    {
        // When
        var reviews = await JikanTests.Instance.GetRecentAnimeReviewsAsync(1);
    ...
    {
        // When
        var reviews = await JikanTests.Instance.GetRecentAnimeReviewsAsync(2);
